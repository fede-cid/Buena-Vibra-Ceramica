...
function Catalogo() {
  ...
  return (
    <div className={CatalogoStyles.container}>
      ¡Solicita nuestro catálogo mayorista ahora haciendo click aquí! Encuentra nuestras increíbles opciones al por mayor y sorprende a tus clientes con productos de alta calidad. ¡No esperes más para hacer crecer tu negocio!
